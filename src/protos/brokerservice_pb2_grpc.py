...
from src.protos import brokerservice_pb2 as src_dot_protos_dot_brokerservice__pb2
...
class BrokerServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ResetBroker = channel.unary_unary(
                ...
                request_serializer=src_dot_protos_dot_brokerservice__pb2.BrokerDetails.SerializeToString,
                response_deserializer=src_dot_protos_dot_brokerservice__pb2.Status.FromString,
                )
...
def add_BrokerServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ResetBroker': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=src_dot_protos_dot_brokerservice__pb2.BrokerDetails.FromString,
                    response_serializer=src_dot_protos_dot_brokerservice__pb2.Status.SerializeToString,
            ),
    }
...
class BrokerService(object):
    ...
    def SendTransaction(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/brokerservice.BrokerService/SendTransaction',
            src_dot_protos_dot_brokerservice__pb2.Transaction.SerializeToString,
            src_dot_protos_dot_brokerservice__pb2.Response.FromString,
    ...
    def ResetBroker(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/brokerservice.BrokerService/ResetBroker',
            src_dot_protos_dot_brokerservice__pb2.BrokerDetails.SerializeToString,
            src_dot_protos_dot_brokerservice__pb2.Status.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
